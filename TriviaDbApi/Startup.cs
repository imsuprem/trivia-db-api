...
using TriviaDbApi.Controllers;

namespace TriviaDbApi
{
    public class Startup
    {
        ...
        GetConnectionString("MyDb")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TriviaDbApi", Version = "v1" });
            });

            services.AddHttpClient<CategoryController>();
